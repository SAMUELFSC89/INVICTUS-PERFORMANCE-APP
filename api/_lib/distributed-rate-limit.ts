 ...
 *
 * O identificador bruto nunca é persistido. Ele participa somente do SHA-256
 * usado como ID opaco do documento, suficiente para compartilhar o contador
 * entre instâncias sem ampliar a exposição de UID/owner_id no Firestore.
 */
