export const VALIDATION_MESSAGES: Record<string, string> = {
  GPS_OUTSIDE_ALLOWED_AREA: "Sua localização foi detectada fora da área permitida para o treino. Verifique se o GPS está ativo e tente novamente.",
  ...
  GPS_SIGNAL_WEAK: "O sinal de GPS estava muito instável ou fraco durante o período. Aproxime-se de áreas abertas no próximo treino para garantir a validação automática.",
