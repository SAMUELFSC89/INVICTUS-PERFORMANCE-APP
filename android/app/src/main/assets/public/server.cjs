...
var activityLimiter = (0, import_express_rate_limit.default)({
  windowMs: 60 * 1e3,
  max: 10,
...
var externalApiLimiter = (0, import_express_rate_limit.default)({
  windowMs: 60 * 1e3,
  max: 20,
...
var scoreLogger = logger.child({ component: "score-engine" });
var fraudLogger = logger.child({ component: "fraud-detection" });
var authLogger = logger.child({ component: "auth" });
var apiLogger = logger.child({ component: "api" });
var syncLogger = logger.child({ component: "sync-service" });
...
var cache = new import_node_cache.default({ stdTTL: 300 });
...
init_common();
var serverRankingCache = /* @__PURE__ */ new Map();
...
var cache2 = new import_node_cache2.default({ stdTTL: 1800, maxKeys: 2e3, useClones: false });
...
var MAX_GEOFENCE_RADIUS_METERS = 80;
var MAX_GPS_ACCURACY_METERS = 30;
...
var RunningRepository = class extends BaseRepository {
  constructor() {
    super("running_stats");
  }
...
var import_node_cache4 = __toESM(require("node-cache"), 1);

// api/_lib/fraud-detection/gps-validator.ts
var import_geolib = require("geolib");
var GPSValidator = class {
...
var BehaviorEngine = class _BehaviorEngine {
  /**
...
var DeviceFingerprintEngine = class {
  /**
...
var NetworkEngine = class _NetworkEngine {
  /**
...
var DeviceSecurityEngine = class {
  /**
...
var GpsEngine = class _GpsEngine {
  /**
...
var ExplainabilityEngine = class {
  /**
...
var SecurityEventBus = class _SecurityEventBus {
  constructor() {
...
var securityEventBus = SecurityEventBus.getInstance();
...
// api/_services/running/running-service.ts
init_common();
var cache3 = new import_node_cache4.default({ stdTTL: 300 });
...
var runningRepository = new RunningRepository();
var runningService = new RunningService(runningRepository);
...
var MIN_STEP_KM = 0.5;
var MAX_STEP_KM = 1.5;
var MIN_SESSIONS_PER_MILESTONE = 2;
var MAX_SESSIONS_PER_MILESTONE = 4;
...
var geminiApiKey = process.env.GEMINI_API_KEY || process.env.GOOGLE_API_KEY;
var habitAi = geminiApiKey ? new import_genai.GoogleGenAI({ apiKey: geminiApiKey }) : null;
...
var ActivityRepository = class extends BaseRepository {
  constructor() {
    super("workouts");
  }
...
var http2 = __toESM(require("node:http2"), 1);
init_common();
var import_messaging = require("firebase-admin/messaging");
var MAX_STORED_NOTIFICATIONS = 50;
var MAX_PUSH_TOKENS = 10;
var MAX_PUSH_DATA_ENTRIES = 10;
...
var calculateConsistencyMultiplier = (streak) => {
...
var ValidateActivityService = class {
...
var validateActivityService = new ValidateActivityService(
  activityRepository,
  userRepository,
  auditRepository,
...
var ai = apiKey ? new import_genai2.GoogleGenAI({ apiKey }) : null;
var POWER_EXERCISES = /* @__PURE__ */ new Set(["supino", "agachamento", "terra"]);
var MAX_POWER_FRAMES = 3;
var MAX_POWER_FRAME_BASE64_LENGTH = 15e5;
...
// api/_handlers/validate-presence.ts
var apiKey2 = process.env.GEMINI_API_KEY || process.env.GOOGLE_API_KEY;
var ai2 = new import_genai3.GoogleGenAI(apiKey2 ? {
  apiKey: apiKey2,
  httpOptions: {
    headers: {
...
init_common();
var ALLOWED_TYPES = ["ranking", "payment", "system", "achievement", "social"];
...
var MultiplierCalculator = class {
  /**
...
var STRAVA_CLIENT_ID2 = process.env.STRAVA_CLIENT_ID;
var STRAVA_CLIENT_SECRET2 = process.env.STRAVA_CLIENT_SECRET;
var STRAVA_REDIRECT_URI = process.env.STRAVA_REDIRECT_URI && process.env.STRAVA_REDIRECT_URI.includes("sem-desculpa.vercel.app") ? process.env.STRAVA_REDIRECT_URI.replace("sem-desculpa.vercel.app", "www.invictusperformance.app.br") : process.env.STRAVA_REDIRECT_URI;
var STRAVA_VERIFY_TOKEN = process.env.STRAVA_VERIFY_TOKEN || process.env.STRAVA_WEBHOOK_SECRET;
...
var requireUserAuth = async (req, res, next) => {
  try {
    const auth = await verifyAuth(req);
    if (!auth) {
...
var AdminRepository = class extends BaseRepository {
  constructor() {
    super("admin_reviews");
  }
...
init_common();
var PERCENTUAL_POTE_PADRAO = 0.55;
...
// src/constants.ts
var SEASON_MIN_PARTICIPANTS_PER_GYM = 1;
var SEASON_TOP5_THRESHOLD_PER_GYM = 150;
var TOP_10_PERCENTAGES = [
  0.2286,
  // 1st: 22.86%
  0.1857,
  // 2nd: 18.57%
...
// api/_handlers/payments-verify-purchase.ts
var REVENUECAT_API_URL = "https://api.revenuecat.com/v1";
...
init_common();
var MemoryRepository = class extends BaseRepository {
  constructor() {
...
init_common();
var DEFAULT_SPONSOR_CHALLENGES = [
  {
...
init_common();
var ALLOWED_PERMISSION_VALUES = /* @__PURE__ */ new Set([
  "read_heart_rate",
  "read_steps",
  "read_distance",
  "read_calories",
...
init_common();
var EXERCISES = /* @__PURE__ */ new Set(["supino", "agachamento", "terra"]);
var MAX_RANKING_RESULTS = 100;
var MAX_MY_RECORDS = 100;
...
var ASAAS_WEBHOOK_TOKEN = process.env.ASAAS_WEBHOOK_TOKEN || "";
var ACTIVE_REGULATIONS = {
  invictus_arena_30d: {
...
var championshipAcceptancesStore = /* @__PURE__ */ new Map();
...
var wrap = (handler42) => async (req, res) => {
  try {
...
var assertHandler = (name, handler42) => {
...
async function startServer() {
  ...
  const PORT = 3e3;
  app2.get("/health", (req, res) => res.status(200).json({ status: "ok" }));
  app2.get("/ping", (req, res) => res.status(200).send("pong"));
  app2.get("/api/health", (req, res) => res.status(200).json({ status: "ok" }));
