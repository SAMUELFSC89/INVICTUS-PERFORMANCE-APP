    ...
    <main className="profile-flow-screen profile-flow-screen-new">
      ...
      <div className="profile-flow-content">
        <section className="profile-flow-document">
          ...
          <h3>FREQUÊNCIA — F</h3>
          <p>Conta sessões válidas na semana. A curva é: 1 treino = 15; 2 = 30; 3 = 55; 4 = 80; 5 = 100; 6 ou mais = 105. A sexta sessão recebe apenas um pequeno bônus e treinar além disso não aumenta F.</p>
          ...
          <h3>INTENSIDADE — I</h3>
          <p>A intensidade usa frequência cardíaca relativa à FC máxima e, quando existe uma série confiável de leituras, considera a distribuição do esforço nas zonas ao longo do treino. Z1 vale menos, Z2 é intermediária, Z3 é a referência, Z4 recebe o maior bônus útil e Z5 não vale mais que Z4. Assim, manter a FC excessivamente alta não vira uma estratégia para acumular IGA.</p>
