    ...
    <main className="profile-flow-screen profile-flow-screen-new">
      ...
      <div className="profile-flow-content">
        <section className="profile-flow-document">
          ...
          <h3>INTENSIDADE — I</h3>
          <p>A intensidade usa frequência cardíaca relativa à FC máxima e, quando existe uma série confiável de leituras, considera a distribuição do esforço nas zonas ao longo do treino. A frequência cardíaca é usada como sinal do desempenho físico durante a sessão para estimar a intensidade relativa do esforço no IGA. Z1 vale menos, Z2 é intermediária, Z3 é a referência, Z4 recebe o maior bônus útil e Z5 não vale mais que Z4. Assim, manter a FC excessivamente alta não vira uma estratégia para acumular IGA.</p>

          <h3>USE O RELÓGIO DURANTE O TREINO</h3>
          <p>Para obter uma medição de intensidade mais completa nas atividades que contam para o IGA, inicie também uma atividade no seu relógio antes de começar o treino no Invictus e mantenha essa atividade ativa até finalizar o treino. Isso ajuda o relógio a registrar frequência cardíaca ao longo de toda a sessão e aumenta a qualidade da série usada pelo Invictus.</p>
