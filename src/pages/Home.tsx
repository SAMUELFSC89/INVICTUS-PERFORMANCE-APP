...
export function Home() {
  ...
  return createPortal(<main className="nh-screen"><div className="nh-page">
    ...
    <SeasonBanner eyebrow="TEMPORADA INVICTUS" title="TREINE. EVOLUA. SUPERE." subtitle="Mostre sua força. Supere seus limites." ctaLabel="VER MAIS" onCtaClick={() => navigate('/championships')} />
