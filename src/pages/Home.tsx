...
export function Home() {
  ...
  return createPortal(<main className="nh-screen"><div className="nh-page">
    ...
    <section className="nh-season"><div className="nh-season-copy"><small className="nh-season-kicker">TEMPORADA INVICTUS</small><h2><span>MUSCULAÇÃO</span><strong><b>+</b> CARDIO</strong></h2><p>Mais evolução. Mais consistência.<br />Mais performance.</p><button onClick={() => navigate('/championships')}>VER TEMPORADA <ArrowRight /></button></div></section>
