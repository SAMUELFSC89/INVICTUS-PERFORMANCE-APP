...
export function ProfileSecondary() {
  ...
  const faqCategoryOrder: FAQItem['category'][] = ['Geral', 'Conta & Perfil', 'Pontuação & IGA', 'Assinaturas PRO', 'Health & Wearables', 'Desafios Privados', 'Saques & PIX', 'Antifraude & Auditoria', 'Privacidade & LGPD'];
