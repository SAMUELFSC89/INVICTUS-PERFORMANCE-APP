...
export const answersSchema = z.object({
  ...
  trainingBackground: z.enum(['inactive', 'occasional', 'regular', 'structured', 'competitive']).optional(),
  primarySport: z.enum(['none', 'running', 'cycling', 'team_sport', 'combat', 'cross_training', 'other']).optional(),
  typicalCardioMinutes: z.union([z.literal(15), z.literal(30), z.literal(45), z.literal(60), z.literal(90)]).optional(),
