...
export const METRIC_CATALOG: PerformanceMetricDef[] = [
  ...
  },
  {
    ...
    technicalDescription: 'Segmentação do tempo de treino em 5 faixas calculadas a partir da FC Máx Biológica (220 - idade): Z1 (50-60%), Z2 (60-70%), Z3 (70-80%), Z4 (80-90%), Z5 (90-100%).',
    formula: '%Z_k = \\frac{\\text{Tempo em } Z_k}{T_{total}} \\times 100',
    unit: '% do tempo',
    dataSources: ['Frequência Cardíaca (Sensor)', 'Apple Health', 'Health Connect', 'Wearables / Garmin / Whoop'],
    howObtained: 'Histograma do sinal cardíaco sincronizado durante treinos.',
    deviceTypes: ['Smartwatch', 'Cinta Cardíaca'],
    updateFrequency: 'Diária',
    minConditions: 'Sessão com dados biométricos contínuos de HR e idade do perfil preenchida.',
